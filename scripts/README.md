...
- `verify_local_directory_import.py`: run a minimal end-to-end directory import verification against the local PostgreSQL database, including child job execution outcomes and parent job execution summary checks
