...
- `verify_local_directory_import.py`: run a minimal end-to-end directory import verification against the local PostgreSQL database, including skipped and pending child job checks
