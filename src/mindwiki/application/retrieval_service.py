...
from mindwiki.application.retrieval_models import BM25Candidate, ChunkHit, RetrievalQuery, RetrievalResult
    ...
    def retrieve(self, query: RetrievalQuery) -> RetrievalResult:
        ...
        if query.retrieval_mode != "bm25_only":
            raise ValueError(
                ...
                "Only bm25_only is implemented in the current stage."
            )
